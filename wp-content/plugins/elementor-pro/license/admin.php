		...
		<div class="wrap elementor-admin-page-license">
			...
			<form class="elementor-license-box" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                ...
                <?php if ( empty( $license_key ) ) : ?>
					...
					<input id="elementor-pro-license-key" class="regular-text code" name="elementor_pro_license_key" type="text" value="Nulled by ProWebber.ru" placeholder="<?php _e( 'Please enter your license key here', 'elementor-pro' ); ?>" />
